...
function Banner() {
    return (
        ...
        <div className="absolute top-1/2 w-full text-center">
            <p className="text-sm sm:text-lg text-white font-bold"> Vous souhaitez partir pour NÖEL ? </p>
            <button className="text-red-500 bg-white px-10 py-4 shadow-md rounded-full font-bold my-3 hover:shadow-xl hover:text-red-400 active:scale-90 transition duration-150"> N'attendez plus ! </button>
        </div>
        </div>
